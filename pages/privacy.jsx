export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Vuupeeland'ın Gizlilik Politikası</h1>
            <p className="text-sm text-white/30 mb-4">Lson Güncelleme: 23/01/2024  🆕️</p>
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <div className="py-3"></div>
        <p>⊳ Vuupeeland'ı kullanırken belirli komutları aynı anda kullanamazsınız.</p>   
        <div className="py-3"></div>
        <p>⊳ Vuupeeland botu kullanıcılara dayalı hiçbir veriyi kaydetmez.</p>
        <div className="py-3"></div>
